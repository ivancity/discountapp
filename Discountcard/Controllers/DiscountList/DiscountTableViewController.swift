...
//  Discountcard
//
//  Created by test on 31/10/16.
//  Copyright © 2016 Mooncascade Ou. All rights reserved.
//

import UIKit

class DiscountTableViewController: UIViewController {
    ...
    private func setupTableView() {
        ...
        let keyboardConstraint = KeyboardConstraint(firstItem: bottomLayoutGuide,
                                   firstAttribute: .bottom,
                                   secondItem: tableView,
                                   secondAttribute: .bottom)
        keyboardConstraint.offset = bottomLayoutGuide.length
        
        view.addConstraint(keyboardConstraint)
...
extension DiscountTableViewController: UITableViewDelegate {
...
extension DiscountTableViewController: UITableViewDataSource {
...
extension DiscountTableViewController: TableViewModelViewDelegate {
    func reloadContents() {
    ...
    func showRecommendedConfirmAction(title: String?, message: String, completion: ((Bool) -> Void)?) {
        ...
        alert = UIAlertController(title: title, message: message)
        {
    ...
    func showPlaceRecommendedAlert(title: String?, message: String) {
        let alert = UIAlertController(title: title, message: message, completion: nil)
        self.present(alert, animated: true, completion: nil)
    }
    
}

extension DiscountTableViewController: DescriptionTableViewCellDelegate{
    func openMapTab() {
